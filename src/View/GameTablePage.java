...
public class GameTablePage extends JFrame{
	...
	private void initialize() {
	    ...
	    labelMoneyCards.setIcon(new ImageIcon((URL)this.getClass().getResource("/otherImages/playerMoney.jpg")));
	    ...
	    moneyCard_1.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    moneyCardJlabelList.add(moneyCard_1);
	    
	    JLabel moneyCard_2 = new JLabel();
	    moneyCard_2.setOpaque(true);
	    moneyCard_2.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyCard_3.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyCard_4.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyCard_5.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyCard_6.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyCard_7.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyCard_8.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyCard_9.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyCard_10.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyCard_11.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyCard_12.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyCard_13.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyCard_14.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    labelMoneyPicker.setIcon(new ImageIcon((URL)this.getClass().getResource("/otherImages/moneyPicker.jpg")));
	    ...
	    moneyPickerCard_1.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyPickerCard_2.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyPickerCard_3.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    moneyPickerCard_4.setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
	    ...
	    pickButton.setIcon(new ImageIcon((URL)this.getClass().getResource("/otherImages/pickButton.png")));
	  //  pickButton.setBorderPainted(false);
	    ...
	    labelStorageArea.setIcon(new ImageIcon((URL)this.getClass().getResource("/otherImages/storageBack.jpg")));
	    ...
	    storageBuildingCard_1.setIcon(new ImageIcon((URL)this.getClass().getResource("/otherImages/storageTop.jpg")));
	    ...
	    storageBuildingCard_2.setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/back.jpg")));
	    ...
	    storageBuildingCard_3.setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/back.jpg")));
	    ...
	    storageBuildingCard_4.setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/back.jpg")));
	    ...
	    storageBuildingCard_5.setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/back.jpg")));
	    ...
	    storageBuildingCard_6.setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/back.jpg")));
	    ...
	    storageBuildingCard_7.setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/back.jpg")));
	    ...
	    storageBuildingCard_8.setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/back.jpg")));
	    ...
	    storageBuildingCard_9.setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/back.jpg")));
	    ...
	    for(int i = 0; i < 21; i++)
	    {
	    	for(int j = 0; j < 21; j++)
	    	{
	    		...
	    		if(i==10 && j==10)
	    			table[i][j].setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/start.jpg")));
	    		else
	    ...
	    helpLabel.setIcon(new ImageIcon((URL)this.getClass().getResource("/evaluationCards/evaluationTable.png")));
	    ...
	    labelBuildingMarket.setIcon(new ImageIcon((URL)this.getClass().getResource("/otherImages/market.jpg")));
	    ...
	    marketBuildingCard_1.setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/back.jpg")));
	    ...
	    marketBuildingCard_2.setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/back.jpg")));
	    ...
	    marketBuildingCard_3.setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/back.jpg")));
	    ...
	    marketBuildingCard_4.setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/back.jpg")));
	   ...
	   // btnBuyBuildingCard.setBorderPainted(false);
	    ...
	    labelCurrency_1.setIcon(new ImageIcon((URL)this.getClass().getResource("/otherImages/blueMarket.png")));
	    ...
	    labelCurrency_2.setIcon(new ImageIcon((URL)this.getClass().getResource("/otherImages/greenMarket.png")));
	    ...
	    labelCurrency_3.setIcon(new ImageIcon((URL)this.getClass().getResource("/otherImages/orangeMarket.png")));
	    ...
	    labelCurrency_4.setIcon(new ImageIcon((URL)this.getClass().getResource("/otherImages/yellowMarket.png")));
	...
	public void playerMoneyCardBackgroundSetter(List<String> backgrounds){
		for(int i=0; i<backgrounds.size(); i++){
			moneyCardJlabelList.get(i).setIcon(new ImageIcon((URL)this.getClass().getResource(backgrounds.get(i))));
			playerMoneyCardsJRadioButtonList.get(i).setSelected(false);
		}
		for(int i=backgrounds.size(); i<moneyCardJlabelList.size(); i++){
			moneyCardJlabelList.get(i).setIcon(new ImageIcon((URL)this.getClass().getResource("/MoneyCards/backCard.jpg")));
			playerMoneyCardsJRadioButtonList.get(i).setSelected(false);
	...
	public void moneyPickerCardBackgroundSetter(List<String> backgrounds){
		for(int i=0; i<backgrounds.size(); i++){
			moneyPickerJlabelList.get(i).setIcon(new ImageIcon((URL)this.getClass().getResource(backgrounds.get(i))));
	...
	public void buildingMarketCardBackgroundSetter(List<String> backgrounds){
		...
		for(int i=0; i<backgrounds.size(); i++){
			tmp = i;
			buildingMarketJlabelList.get(i).setIcon(new ImageIcon((URL)this.getClass().getResource(backgrounds.get(i))));
			
			if(backgrounds.get(i).equals("/buildingCards/back.jpg")) {
	...
	public void storageAreaCardBackgroundSetter(List<String> backgrounds){
		...
		for(int i = backgrounds.size(); i < storageAreaCardsJlabelList.size(); i++) {
			storageAreaCardsJlabelList.get(i).setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/back.jpg")));
		}
	}
		...
		for(int i=0; i<matrix.length; i++){
			for(int j=0; j<matrix[i].length; j++){
				if(matrix[i][j].equals("null")){
					...
					table[i][j].setIcon(new ImageIcon((URL)this.getClass().getResource(matrix[i][j])));
				}
			}
		}
		table[10][10].setIcon(new ImageIcon((URL)this.getClass().getResource("/buildingCards/start.jpg")));
	}
